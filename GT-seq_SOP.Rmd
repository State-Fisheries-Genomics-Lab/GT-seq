...
# now we'll clean up this file a little bit, you can do this in a text editor or the console
...
#this part changes the values of A=2, G=898, etc for the allele count columns to the actual values
