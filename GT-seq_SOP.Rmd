...
require(tidyverse)
require(DiagrammeR)
#require(related) # don't need to install or use this package unless running duplicate filtering (for messy batch samples)
require(adegenet)
require(knitr)
require(magrittr)
require(lme4)
